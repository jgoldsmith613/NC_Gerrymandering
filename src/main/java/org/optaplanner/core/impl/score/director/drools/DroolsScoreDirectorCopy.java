 ...
 * @see ScoreDirector
 */
public class DroolsScoreDirectorCopy<Solution_>
    ...
    public DroolsScoreDirectorCopy(DroolsScoreDirectorFactory<Solution_> scoreDirectorFactory,
    ...
    @Override
    public DroolsScoreDirectorCopy<Solution_> clone() {
        ...
        return (DroolsScoreDirectorCopy<Solution_>) super.clone();
    }
